...
🔭 Cloud enthusiast | AWS CDA... | Hashicorp Certified Terraform Associate In Progress...

🌱 I’m currently learning working with tools like **AWS (EC2, Lambda, S3, Step-Functions,SQS,...), JS, Python, Github Actions, Terraform, and Agentic AI**
